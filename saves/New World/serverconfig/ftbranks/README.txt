...
Last README file update: Fri Jan 17 14:19:42 EST 2025
...
command.ascend.args
command.ascendant
command.ascendant.distance
command.ascendant.distance.debug
command.ascendant.distance.get
command.ascendant.distance.get.level
command.attribute
...
command.motp
command.motp.add
command.motp.add.attributes
command.motp.add.attributes.attribute_Id
command.motp.add.attributes.attribute_Id.count
command.motp.add.attributes.attribute_Id.count.player
command.motp.add.level
command.motp.add.level.player
command.motp.add.level.player.amount
command.motp.add.xp
command.motp.add.xp.amount
command.motp.add.xp.amount.player
command.motp.reset
command.motp.reset.player
command.motp.set
command.motp.set.xp
command.motp.set.xp.amount
command.motp.set.xp.amount.player
command.msg
command.msg.targets
